        ...
        <section className="mb-12 bg-gray-800 p-6 rounded-lg">
          <div className="bg-gray-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300 mb-4">
              Plant Identifier was created in 2026 out of a personal need to
        ...
        <section className="mb-12 bg-gray-800 p-6 rounded-lg">
          ...
          <div className="flex flex-col items-center md:flex-row md:items-start space-y-4 md:space-y-0 md:space-x-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300 mb-4">
                Tejas , currently pursuing a degree in Computer Science, is passionate about leveraging technology to solve real-world problems. With a keen interest in AI and nature,  created Plant Identifier to help people connect with the natural world through technology. When not coding, also enjoys  photography, and exploring new plant species.
              </p>
              <div className="flex space-x-4">
                ...
                <a
                  href="https://www.linkedin.com/in/tejas-shah-5b3481250/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300"
                >
